...
struct qdldl {
    ...
    c_int (*update_sigma_vec)(struct qdldl * self, const c_float sigma_vec);      ///< Update rho_vec parameter
#endif
    ...
    c_float *sigma_vec;          ///< scalar parameter
#ifndef EMBEDDED
    ...
    c_int * sigmatoKKT;            ///< Index of sigma places in KKT matrix
