...
// /**
//  * Set values of sigma vector based on constraint types
//  * @param work Workspace
//  */
// void    set_sigma_vec(OSQPWorkspace *work);

// /**
//  * Update values of sigma vector based on updated constraints.
//  * If the constraints change, update the linear systems solver.
//  *
//  * @param work Workspace
//  * @return     Exitflag
//  */
// c_int   update_sigma_vec(OSQPWorkspace *work);
