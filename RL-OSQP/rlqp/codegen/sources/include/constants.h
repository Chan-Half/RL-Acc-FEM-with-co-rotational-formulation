...
*************************/
enum linsys_solver_type { QDLDL_SOLVER, SPSLU_SOLVER, MKL_PARDISO_SOLVER };
...
enum rlqp_adaptive_sigma_type {
    RLQP_ADAPTIVE_SIGMA_DISABLE = 0,
    RLQP_ADAPTIVE_SIGMA_STANDARD = 1,
    RLQP_ADAPTIVE_SIGMA_SCALAR_POLICY = 2,
    RLQP_ADAPTIVE_SIGMA_VECTOR_POLICY = 3,
};
...
# define LINSYS_SOLVER (SPSLU_SOLVER)
...
#define SIGMA_VEC_MIN (1E-8)
#define SIGMA_VEC_MAX (1E8)
...
#  define ADAPTIVE_SIGMA (RLQP_ADAPTIVE_SIGMA_STANDARD)
